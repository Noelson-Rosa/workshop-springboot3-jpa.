...
import com.educandoweb.course.repositories.OrderItemReporsitory;
import com.educandoweb.course.repositories.OrderReporsitory;
import com.educandoweb.course.repositories.ProductReporsitory;
...
public class TestConfig implements CommandLineRunner{
	...
	@Autowired
	private OrderItemReporsitory orderItemRepository;
	...
	public void run(String... args) throws Exception {
		...
		userReporsitory.saveAll(Arrays.asList(u1  , u2));
